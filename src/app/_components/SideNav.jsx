  ...
  return (
    <div className="border shadow-md h-screen p-5">
      ...
      {menuList.map((menu, index) => (
        <h2 className="flex items-center gap-2 gap-y-3 text-md p-4 text-slate-500 hover:bg-primary hover:text-white cursor-pointer rounded-lg transition-all my-2">
          <menu.icon />
          {menu.name}
        </h2>
      ))}
